...
import { SelectChangeEvent, Container, Box, Grid } from "@mui/material";
...
export default function SignaturePage() {
  ...
  const copyToClipboard = () => {
    const textToCopy = "<div style=\"font-family: " + userFont + "; color: " + userColor + "\"><div>" + quoteRes.quote + "</div><br /><div>~" + randomAuthor + "</div><br /><img src=\"" + gifUrl + "\" /><br /><div>Generated by <a href=\"my-email-signature.netlify.app\">My Email Signature Generator</a></div>"
      ...
      <main>
        ...
        <Grid container spacing={2} sx={{ mt: 2, mb: 2 }}>
          <Grid item xs={12} sm={4}>
            ...
            label={showAuthor ? "Click to hide the real author" : "Click to reveal the real author"}
            />
          </Grid>
          <Grid item xs={12} sm={4}>
            <CustomButton
